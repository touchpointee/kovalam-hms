    ...
    return (
      <div className="space-y-4">
        ...
        <Button asChild variant="outline">
          <Link href="/doctor/patients">Back to Patient Search</Link>
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold">Patient Details</h1>
          <p className="text-sm text-muted-foreground">Doctor view</p>
        </div>
      ...
      <Card className="border-blue-100">
        ...
        <CardContent className="grid gap-2 text-sm sm:grid-cols-2">
          <p>
            <strong>Reg No:</strong> {patient.regNo}
          </p>
          <p>
          ...
          <p>
            <strong>Gender:</strong> <span className="capitalize">{patient.gender}</span>
          </p>
          <p>
              ...
              <TableBody>
                {visits.map((v) => (
                  <TableRow key={v._id}>
                    ...
                    <TableCell>{typeof v.paid === "boolean" ? (v.paid ? "Yes" : "No") : "-"}</TableCell>
                    <TableCell>
