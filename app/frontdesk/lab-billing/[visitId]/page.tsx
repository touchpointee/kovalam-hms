...
export default function FrontdeskLabBillingVisitPage() {
        ...
        <>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Lab billing is locked to this visit only</CardDescription>
            </CardHeader>
